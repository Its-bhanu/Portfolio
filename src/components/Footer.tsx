      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center pb-8 border-b border-gray-200">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-2 text-sm text-gray-600 max-w-md">
              Creating exceptional digital experiences with a focus on clean design and powerful functionality.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="flex flex-col space-y-2">
                {[
                  { name: "Twitter", href: "#" },
                  { name: "LinkedIn", href: "https://www.linkedin.com/in/bhanu-sharma-9b9139261/" },
                  { name: "GitHub", href: "https://github.com/Its-bhanu/" },
        ...
        <div className="mt-8 flex flex-col items-center">
          <p className="text-sm text-gray-500">
            © {currentYear} Bhanu Sharma. All rights reserved.
          </p>
          <div className="mt-2 flex justify-center space-x-6">
            {[
              ...
              {
                name: "LinkedIn",
                href: "https://www.linkedin.com/in/bhanu-sharma-9b9139261/",
                icon: (
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {
                name: "GitHub",
                href: "https://github.com/Its-bhanu/",
                icon: (
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path
                      fillRule="evenodd"
